...
VALUES
(1, 'Jongleur', 'Prêt à mettre le feu à votre soirée', 'avatars/default.jpeg', 'Liste de toutes les contraintes', 'Prix à l''heure', 25.50, 2, 5, 15, 09, 22),
...
(1, 'Magicien', 'Groupe live pour animer vos soirées et réceptions', 'avatars/default.jpeg', 'Besoin d''une scène et d''équipement audio fourni', 'Prix par événement', 500, 5, 10, 500, 10, 24)
